...
enum { AFC_DYNAMIC_CLASS_ERR_METHOD_NOT_FOUND = AFC_DYNAMIC_CLASS_BASE + 1 };

enum {	AFC_DYNAMIC_CLASS_RESULT_TYPE_UNKNOWN = 0,
...
/* Function Prototypes */
#define afc_dynamic_class_delete(dc)	if ( dc ) { _afc_dynamic_class_delete ( dc ); dc = NULL; }
