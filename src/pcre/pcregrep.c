...
directory_type *opendirectory(char *filename) { return NULL; }
                ...
                BOOL only_one_at_top)
{
  ...
  rc = pcregrep(in, (filenames_only || (show_filenames && !only_one_at_top)) ? filename : NULL);
  fclose(in);
  return rc;
}
