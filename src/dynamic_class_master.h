...
enum {	AFC_DYNAMIC_CLASS_MASTER_ERR_DLSYM = AFC_DYNAMIC_CLASS_MASTER_BASE + 1,
...
// TAGS
enum {	AFC_DYNAMIC_CLASS_MASTER_TAG_INFO = AFC_DYNAMIC_CLASS_MASTER_BASE + 1,
	AFC_DYNAMIC_CLASS_MASTER_TAG_CHECK_PARAMS 
};

/* INFO Definitions */
enum { 	AFC_DYNAMIC_CLASS_MASTER_INFO_NAME = AFC_DYNAMIC_CLASS_MASTER_BASE + 1,	// Name of the Dynamic Class
...
/* Function Prototypes */
#define afc_dynamic_class_master_delete(dcm)	if ( dcm ) { _afc_dynamic_class_master_delete ( dcm ); dcm = NULL; }
