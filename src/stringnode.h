...
enum { 	AFC_STRINGNODE_ERR_CHANGE  = AFC_STRINGNODE_BASE + 1,
	AFC_STRINGNODE_ERR_NULL_STRING,
	AFC_STRINGNODE_ERR_NULL_DELIMITERS };

enum {	AFC_STRINGNODE_TAG_DISCARD_ZERO_LEN = AFC_STRINGNODE_BASE + 1,
...
#define afc_stringnode_delete(sn)	if ( sn ) { _afc_stringnode_delete ( sn ); sn = NULL; }
